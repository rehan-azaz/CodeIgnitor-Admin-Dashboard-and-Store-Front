        ...
        <div class="content-wrapper">
            <div class="container mt-5">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <a href="<?php echo base_url()?>products/addproduct">
                            <button class="btn btn-outline-secondary float-right mb-3">Add Product</button>
                        </a>
        ...
        <script>
            $(document).ready(function(){
                $('#products-table').DataTable({
                    ...
                    "order": [[0, "desc" ]],
                    "ajax": {
                        "url": "<?php echo base_url('products/fetchProducts'); ?>",
                        "type": "POST"
                    },
                    "columnDefs": [{
                        "targets": [3, 5],
