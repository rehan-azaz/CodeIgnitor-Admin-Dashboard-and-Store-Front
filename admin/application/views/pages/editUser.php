            ...
            <div class="container">
                    ...
                    <div class="modal-content  my-4">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo base_url()?>users/validateEditUser?id=<?php echo $userData[0]->id?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="first_name">First Name</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo $userData[0]->first_name?>" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="last_name">Last Name</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="last_name" name="last_name" value="<?php echo $userData[0]->last_name?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="email" class="form-control" id="email" name="email" value="<?php echo $userData[0]->email?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control" id="image" name="image" value="<?php echo $userData[0]->image?>" >
                                        </div>
                                    </div>
