...
<!--        --><?php //include 'navbar.php'?>
        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <form action="<?php echo base_url()?>products/validateAddProduct" class="form-horizontal" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea type="text" class="form-control" id="editor" name="product_info"></textarea>
                                    </div>
                                </div>
                                <script>
                                    ClassicEditor
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="file" onchange="showImages()" multiple class="form-control" id="product_image" name="product_image[]" >
                                    </div>
                                </div>
                            ...
                            <script>
                                function showImages(){
                                    ...
                                    for(var i=0;i<total_file;i++) {
                                        $('#showImage').append("<div class='card col-sm-1'><img src='"+"<?php echo base_url()?>assets/img/"+files[i]['name']+"'/></div>");
                                    }
                                }
