            ...
            <div class="container">
                ...
                <div class="modal-content  my-4">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url()?>category/validateEditCategory?id=<?php echo $categoryData[0]->id?>" class="form-horizontal" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="name">Name</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $categoryData[0]->name?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="file" class="form-control" id="image" name="image" value="<?php echo $categoryData[0]->image?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea rows="5" class="form-control" name="description" value="<?php echo $categoryData[0]->description?>" > <?php echo $categoryData[0]->description?> </textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
